...
And the breakdowns for the various versions of Internet Explorer, where "IE x" is all versions other than IE 6span>/span> and <span class="caps">IE 7</span>.
